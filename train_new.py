...
seed = 2024   # We use seed = 1475 on IEMOCAP and seed = 67137 on MELD
...
if __name__ == '__main__':
    ...
    parser.add_argument('--windows', type=int, default=5, help='windows for hyperedges')

    parser.add_argument('--step', type=int, default=6, help='step for hyperedges')
